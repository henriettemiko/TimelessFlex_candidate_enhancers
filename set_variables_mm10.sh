...
INPUT_DIR=/fast/AG_Ohler/henriette/Dario_project/input
START_DIR=/fast/AG_Ohler/henriette/Dario_project/
DATA_DIR=/fast/project/PG_Lupianez_SLacadie/FASTQ_ATACseq_ChIPseq_GarciaMoreno2018
