%%%%%%%%%%
%name:          learn_cluster_K27ac.m
%description:   learns model and clusters regions
...
%define paths
cd '/fast/AG_Ohler/henriette/Dario_project/bnt-master';
...
for (numClusters = startNum:endNum)
    ...
    % 4 fold changes and 1 histone mark
    % 4+1=5 nodes in network
    % 5 x 5 matrix (0: no edge, 1: directed edge)
    ...
    %dag(8,9) = 1;
    %
    %% third histone modification tree H3K4me3
    %dag(10,11) = 1;
    %dag(11,12) = 1;
    %dag(12,13) = 1;


    inFile = [signalGeneratorDir '/allFold_data_K27ac.txt'];
    disp(inFile);
